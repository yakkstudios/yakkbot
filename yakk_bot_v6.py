# yakk_bot_v6.py
# $YST Telegram Bot 😈💜  v6.0
#
# v6.0: Token migrated $YAKK → $YST. New CA updated. Removed yakkdrip X account.
#        All token/bot references updated. X accounts: @YAKKStudios + @yakkops2 only.
#
# v5.3 changes:
...
#   2. X_MAIN_ACCOUNTS_DEFAULT fixed to ["yakkstudios", "yakkops2"]
#      (lowercase, no @, matches existing parser). Comment updated accordingly.
#   3. /ca command added — replies with $YST Solana CA + DexScreener link.
#   4. /linktree command added — replies with the $YST empire link hub.
...
#   X_MAIN_ACCOUNTS     — comma-separated handles (overrides default), e.g. @YAKKStudios,@yakkops2
#
...
# $YST token on Solana
YAKK_CA         = "jYwmSavfx69a35JEkpyrxu9JUjvswEvfnhLCDV9vREV"
...
NFT_WL_MIN_STAKE    = 250_000  # minimum $YST staked for WL NFT mint eligibility
...
# Comma-separated handles from .env override (e.g. "@YAKKStudios,@yakkops2").
...
X_MAIN_ACCOUNTS_DEFAULT: list[str] = (
    ...
    else ["yakkstudios", "yakkops2"]  # v6.0: official accounts — @YAKKStudios, @yakkops2
)
...
WELCOME_MESSAGES = [
    (
        ...
        "🐾 Check pinned posts for $YST lore.\n"
    ...
    (
        ...
        "Welcome to $YST, degen. The herd is watching. 😈💜\nGET YAKKED. 😈"
    ),
    (
...
YAK_FACTS = [
    ...
    "💜 Yakk wool (called 'khullu') is softer than cashmere and 3x warmer. Just like $YST holders — soft hands? EXPELLED.",
    "😈 Yakks communicate through grunt-like sounds. This Telegram group is basically the same thing.",
    "🏔️ A yakk's lungs are 3x the size of a normal cow's. They were built for altitude. $YST was built for all-time highs.",
    "💛 Yakk milk is naturally pink-tinged. It was always the pink yakk. It was always $YST.",
...
ROAST_POOL = [
    ...
    # ── new 40 roasts (v5.4) ──────────────────────────────────────────────────
    # paper hands / weak bags
    "your bags are lighter than my yakk's pink fluff after a shave. embarrassing. GET YAKKED. 😈",
    "you panic sold at -10%? the yakk laughed from 6,000 metres up. genuinely embarrassing. 😈🏔️",
    "paper hands in a pink cult is like showing up to a sword fight with a napkin. sort it out. 💜😈",
    "you sold the bottom AND bought the top. that's not investing, that's performance art. the mountain is not your audience. 😈",
    "your conviction has the lifespan of a match in a blizzard. the yakk burns forever. GET YAKKED. 😈💜",
    "sold at a loss and now you're 'waiting for the right entry'. the mountain didn't wait. $YST didn't wait. 🏔️😈",
    "your diamond hands turned to dust somewhere around the first red candle. the yakk noticed. 😈",
    "you went 50% stable coin 'just in case'. in case of what? gains? the yakk has no stable coins. only mountain. 🏔️💜",
    # Gen III / Peaky Blinders shade
    "Gen III table is reserved for diamond hooves only. you still holding paper? get clipped. 🎩😈",
    "by order of the YAKK Brotherhood: your flat cap privileges have been revoked until you stake. 😈💜",
    "the den has standards. sharp suits, locked bags, zero excuses. you showed up with none of those. GET YAKKED. 🎩😈",
    "Gen III drops for the locked lords. you're not locked. you're not a lord. the syndicate has noted this. 🔒😈",
    "a Peaky Blinders degen with no $YST staked is just a degen in a hat. fix it. 😈🏔️",
    "the brotherhood reviewed your on-chain activity. they said no. stake more, talk less. GET YAKKED. 😈💜",
    "razor blades in the hat, gold drip on the hooves, zero $YST staked in your wallet. pick two. 🎩😈",
    # $FWOG / $MOG shade
    "$FWOG holders are panic-posting in their pond group right now. at least you found the mountain. now act like it. 😈🏔️",
    "the frog jumped. the cat missed the pump. and here you are on the mountain, still not staked. incredible. 😈💜",
    "$MOG had a moment. $FWOG had a moment. $YST has a mountain range. one of these is permanent. 😈",
    "heard $FWOG is doing a comeback arc. the yakk heard that too and kept grazing. unbothered. 😈🏔️",
    "your frog bags are ribbiting. your yakk bags could be roaring. the choice was always yours. 💜😈",
    # raid shame
    "you called 'LFG' in chat and then logged off. the G stands for GO. GET YAKKED. 😈",
    "raid XP: zero. leaderboard: invisible. the mountain is starting to think you're a bot. 🏔️😈",
    "you were 'on your way' to the raid. the raid ended. the yakk had already grazed and left. 😈💜",
    "liked the raid post with a 🔥, did not raid. a fire emoji is not a contribution. GET YAKKED. 😈🏔️",
    "last raid you typed 'let's go!' and then disappeared. haunting. the mountain remembers. 💜😈",
    # meme / content shame
    "you've been here for weeks and your meme count is zero. the pink yakk deserves better content. 😈",
    "no memes, no raids, no stake. what exactly is your role in this herd? mascot? 🏔️😈",
    "you dropped a jpeg from 2021 and called it a contribution. the yakk has seen better cave paintings. 😈💜",
    "your only message this week was 'gm'. the mountain needs more than morning greetings. 😈🏔️",
    # chart / trading stupidity
    "leveraged long at resistance. the yakk has never once used leverage. the yakk is profitable. think about that. 😈💜",
    "you've re-entered this trade four times at worse prices each time. the yakk calls this 'the degen spiral'. 🏔️😈",
    "your TA said buy. your TA said buy six times before that too. how's the portfolio looking? 😈",
    "bought the news, sold the rumour. you did it backwards. like your chart. GET YAKKED. 😈💜",
    "you're reading 15-minute candles on a mountain built for eternity. zoom out or get grazed. 😈🏔️",
    # non-stakers
    "the staking pool is live and printing and you're sitting liquid. that's not a strategy, that's fear. 🔒😈",
    "every hour you're not staked, someone else is earning the drip that should be yours. think on that. 😈💜",
    "you said you'd stake 'when the time is right'. the mountain has been right since day one. STAKE UP. 🏔️😈",
    # general chaos
    "not staked, not raiding, not memeing. what exactly are you doing on this mountain? leaf-peeping? 💜😈",
    "the mountain doesn't care about your feelings. it cares about your conviction. show some. GET YAKKED. 😈🏔️",
    "your portfolio needs a flat cap and a spine. in that order. then come back to the table. 🎩😈",
    "the yakk survived -40°C, a bear market, and your FUD. it will survive whatever comes next too. 😈💜",
]
...
_STAKE_MESSAGES = [
    (
        ...
        "The $YST staking pool is LIVE. The den is open. The table is set.\n\n"
        "🃏 What the house pays out:\n"
        "• $YST reflections — passive drip into your wallet, sharp as a razor blade\n"
        ...
        "WL seat at the table: Genesis hold + min {min_stake:,} $YST staked.\n"
    ...
    (
        ...
        "Stake on StakePoint → earn $YST reflections + $SPT rewards.\n"
        ...
        "WL access: Stack {min_stake:,}+ $YST in the pool and hold Genesis.\n"
    ...
    (
        ...
        "Sharp suits. Flat caps. Razor blades in the hatband. $YST in the wallet.\n"
        "Staking is live. The back-room rewards are flowing.\n\n"
        "📊 $YST staking on StakePoint:\n"
        "→ $YST reflections — passive, ruthless, automatic\n"
        ...
        "WL mint: Genesis hold + {min_stake:,} $YST staked. Miss it and miss everything.\n"
...
PROMPT_SCENES = [
    ...
    },
    {
        ...
        "template": (
            ...
            "each yakk wearing a cult robe and holding a pink banner with $YST logo, "
    ...
    },
    {
        ...
        "template": (
            ...
            "neon-soaked rainy alley backdrop, glitch effects, holographic $YST logos floating in the air, "
    ...
    },
    {
        ...
        "template": (
            "Dark fantasy throne room illustration, {yakk} seated on a towering icy obsidian throne engraved with $YST runes, "
    ...
    },
    {
        ...
        "template": (
            ...
            "holographic staking dashboards floating around it showing locked $YST bags and $SPT reward flows, "
...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    await update.message.reply_text(
        "😈 $YST Bot v6.0 is LIVE on the mountain. GET YAKKED. 😈\n\n"
        "Commands:\n"
        ...
        "/price — check $YST price\n"
        "/ca — $YST contract address + DexScreener link\n"
        "/linktree — the full $YST empire link hub\n"
...
async def cmd_leaderboard(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    lines  = ["😈💜 $YST RAID LEADERBOARD 💜😈 — GET YAKKED.", "🏔️ Top Warriors of the Mountain:\n"]
...
async def cmd_price(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(
        f"😈 $YST PRICE CHECK {emoji}\n\n"
        f"Price: ${price:.8f}\n"
        f"5min change: {change_str}\n\n"
        f"🔗 Chart: {url}\n\n"
        f"{vibe}\n\n"
        f"💰 Stake your $YST for passive drip while you wait:\n"
...
async def cmd_ca(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    """Reply with the $YST Solana contract address and DexScreener link."""
    await update.message.reply_text(
        "😈🏔️ $YST CONTRACT ADDRESS — the mountain doesn't rug.\n\n"
        f"<code>{YAKK_CA}</code>\n\n"
...
async def cmd_linktree(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    """Reply with the full $YST empire link hub."""
    await update.message.reply_text(
        "😈💜 THE $YST EMPIRE — enter at your own risk.\n\n"
...
async def cmd_wlcheck(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text(
        ...
        f"• Hold a Genesis $YST NFT\n"
        f"• Stake minimum {NFT_WL_MIN_STAKE:,} $YST on StakePoint\n\n"
...
async def _fetch_yakk_price() -> tuple:
    """
    Fetch $YST price from DexScreener.
    ...
    try:
        ...
        if not pairs:
            logger.warning("DexScreener returned no pairs for $YST CA")
            return None, 0.0, ""
...
async def job_daily_stake_reminder(context: CallbackContext) -> None:
    ...
    stake_reminder_variants = [
        (
            ...
            "By order of the YAKK Brotherhood — are your $YST bags locked in?\n\n"
            "The back-room rewards are FLOWING right now 🌊\n"
            "→ $YST reflections hitting wallets — silent, ruthless, automatic\n"
        ...
        (
            ...
            "💰 $YST reflection rewards — sharp as a razor blade\n"
        ...
        (
            "💜🎩 THE CULT EARNS WHILE THE CITY SLEEPS 🎩💜\n\n"
            "Sharp suits. Flat caps. Cigar smoke. $YST in the wallet. $SPT dripping.\n"
            "You hold. You stake. $YST pays you. The cycle is as old as the mountain.\n\n"
            ...
            f"WL mint requires {NFT_WL_MIN_STAKE:,}+ $YST staked + Genesis hold.\n\n"
...
async def job_weekly_raid_reminder(context: CallbackContext) -> None:
    ...
    await context.bot.send_message(
        ...
        text=(
            "😈 WEEKLY RAID SYNC 💜\n\n"
            "It's raid day, herd.\n\n"
            "Find a $YST post on X and use /raid [link] to coordinate.\n"
            "Type /done after raiding to log your Raid XP. 🏅\n"
...
def main() -> None:
    ...
    app.add_handler(CommandHandler("yakkstudios",         cmd_yakk))
    ...
    print("😈💜 $YST Bot v6.0 is running. Pink fur. Gold drip. Flat caps. No rugs. GET YAKKED. 😈🏔️")
    logger.info("$YST Bot v6.0 started — GET YAKKED. 😈 JobQueue active, polling started.")
