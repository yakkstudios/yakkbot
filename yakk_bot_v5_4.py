# yakk_bot_v5_4.py
# $YAKK Telegram Bot 😈💜  v5.4
#
# v5.4: Expanded ROAST_POOL to 50 savage yakk roasts (10 originals kept, 40 new added)
#
# v5.3 changes:
...
ROAST_POOL = [
    ...
    "sold at a loss and now you're 'waiting for the right entry'. the mountain didn't wait. $YAKK didn't wait. 🏔️😈",
    ...
    "a Peaky Blinders degen with no $YAKK staked is just a degen in a hat. fix it. 😈🏔️",
    "the brotherhood reviewed your on-chain activity. they said no. stake more, talk less. GET YAKKED. 😈💜",
    "razor blades in the hat, gold drip on the hooves, zero $YAKK staked in your wallet. pick two. 🎩😈",
    # $FWOG / $MOG shade
    ...
    "$MOG had a moment. $FWOG had a moment. $YAKK has a mountain range. one of these is permanent. 😈",
